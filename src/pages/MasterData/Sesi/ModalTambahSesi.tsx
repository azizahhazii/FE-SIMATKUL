...
interface ModalTambahSesiProps {
  isOpen: boolean
  onClose: () => void
  onSave: (jamMulai: string, jamBerakhir: string) => void
}

export function ModalTambahSesi({
  isOpen,
  onClose,
  onSave,
}: ModalTambahSesiProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs">
      <div className="w-full max-w-xl rounded-3xl bg-white p-8 shadow-xl flex flex-col gap-6 animate-in fade-in zoom-in duration-150">
        ...
        <div className="flex flex-col text-center gap-1">
          <h3 className="text-xl font-bold text-slate-800">Tambah Sesi</h3>
...
export default ModalTambahSesi